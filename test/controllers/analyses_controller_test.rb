...
class AnalysesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create analysis" do
    assert_difference('Analysis.count') do
      post analyses_url, params: { analysis: { author: @analysis.author, description: @analysis.description, posted_ad: @analysis.posted_ad, video_game_id: @analysis.video_game_id } }
    end
  ...
  test "should update analysis" do
    patch analysis_url(@analysis), params: { analysis: { author: @analysis.author, description: @analysis.description, posted_ad: @analysis.posted_ad, video_game_id: @analysis.video_game_id } }
